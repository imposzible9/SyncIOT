...
const SignInScreen = ({ navigation }) => {
    ...
    //const [IsListItem, setIsListItem] = React.useState(null);
                    ...
                    >
                        ...
                        <View style={styles.action}>
                            ...
                            <TextInput
                                ...
                                returnKeyType="go"
                                onSubmitEditing={() => { /*loginHandle(data.username, data.password)*/ renderLoading() }}
                            />
                            <TouchableOpacity
                        ...
                        <View style={styles.button}>
                            <TouchableOpacity
                                style={styles.signIn}
                                onPress={() => { /*loginHandle(data.username, data.password)*/ renderLoading() }}
                            >
                                <LinearGradient
